...
void Input::Initialize(WinApp* window)
{
	...
	result = DirectInput8Create(pWindow->GetWindowClass().hInstance, DIRECTINPUT_VERSION, IID_IDirectInput8, (void**)&dinput, nullptr);
...
void Input::SetMousePos(Vector2 pos)
{
	...
	SetCursorPos((int)(pos.x + tmpRect.left + pWindow->GetFrameWidth()), (int)(pos.y + tmpRect.top + pWindow->GetFrameHeight()));
}
